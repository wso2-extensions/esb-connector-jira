...
public class JiraConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        init("jira-connector-1.0.1-SNAPSHOT");
...
//    }
     ...
     * @throws IOException
     */
    @Test(groups = {"wso2.esb"}, description = "jira {getComponentsOfProject} integration test with mandatory parameters.")
    public void testGetComponentsOfProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getComponentsOfProject_mandatory.json");
    ...
    public void testGetAvatarsForProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getAvatarsForProject_mandatory.json");
    ...
    public void testGetRolesOfProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getRolesOfProject_mandatory.json");
    ...
    public void testGetStatusesOfProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getStatusesOfProject_mandatory.json");
    ...
    public void testGetVersionsOfProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getVersionsOfProject_mandatory.json");
    ...
    public void testGetUserPermissionsWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getUserPermissions_mandatory.json");
    ...
    public void testGetDashboardsWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getDashboards_mandatory.json");
    ...
    public void testGetIssuePrioritiesWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getIssuePriorities_mandatory.json");
    ...
    public void testGetIssueTypesWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getIssueTypes_mandatory.json");
