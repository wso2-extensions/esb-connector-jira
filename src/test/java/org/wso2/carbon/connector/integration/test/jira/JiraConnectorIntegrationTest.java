...
public class JiraConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        init("jira-connector-1.0.5-SNAPSHOT");
    ...
    @Test(groups = {"wso2.esb"},
            description = "jira {createComponent} integration test with mandatory parameters.")
    public void testCreateComponentWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_createComponent_mandatory.json");
        ...
        Assert.assertEquals(connectorProperties.getProperty("componentNameMandatory"),
                            apiRestResponse.getBody()
                .getString("name"));
        Assert.assertEquals(connectorProperties.getProperty("project"),
                            apiRestResponse.getBody().getString("project"));
    }
     ...
     */
    @Test(groups = {"wso2.esb"},
            description = "jira {createComponent} integration test with optional parameters.")
    public void testCreateComponentWithOptionalParameters() throws IOException, JSONException {

        esbRequestHeadersMap.put("Action", "urn:createComponent");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_createComponent_optional.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 201);
        ...
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET",
                                                                       apiRequestHeadersMap);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(connectorProperties.getProperty("componentNameOptional"),
                            apiRestResponse.getBody()
                .getString("name"));
        Assert.assertEquals(connectorProperties.getProperty("project"), apiRestResponse.getBody().
                getString("project"));
     ...
     * @throws IOException
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateComponentWithMandatoryParameters"},
            description = "jira {createComponent} integration test with negative case.")
    public void testCreateComponentWithNegativeCase() throws IOException, JSONException {

        esbRequestHeadersMap.put("Action", "urn:createComponent");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_createComponent_negative.json");
        String apiEndPoint = apiUrl + "/component";

        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
                                    "api_createComponent_negative.json");

        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), apiRestResponse.getHttpStatusCode());
        Assert.assertEquals(apiRestResponse.getBody().getJSONObject("errors").getString("name"),
                            esbRestResponse
                .getBody().getJSONObject("errors").getString("name"));
        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("errorMessages").length(),
     ...
     * @throws IOException
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateComponentWithOptionalParameters"},
            description = "jira {getComponent} integration test with mandatory parameters.")
    public void testGetComponentWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getComponent_mandatory.json");
        ...
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), apiRestResponse.getHttpStatusCode());
        Assert.assertEquals(esbRestResponse.getBody().getString("name"), apiRestResponse.getBody().
                getString("name"));
        ...
        Assert.assertEquals(esbRestResponse.getBody().getString("description"),
                apiRestResponse.getBody().getString("description"));
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("lead").getString("name"),
                            apiRestResponse.getBody()
    ...
    public void testGetComponentWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getComponent_negative.json");
        ...
        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("errorMessages").length(),
                            esbRestResponse.getBody()
                .getJSONArray("errorMessages").length());
        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("errorMessages").getString(0),
                            esbRestResponse
    ...
    @Test(priority = 1, groups = {"wso2.esb"},
            dependsOnMethods = {"testCreateComponentWithOptionalParameters"},
            description = "jira {updateComponent} integration test with optional parameters.")
    public void testUpdateComponentWithOptionalParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_updateComponent_optional.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
     ...
     */
    @Test(groups = {"wso2.esb"},
            description = "jira {updateComponent} integration test with negative case.")
    public void testUpdateComponentWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_updateComponent_negative.json");

        String apiEndPoint = apiUrl + "/component/INVALID";

        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap,
                                    "api_updateComponent_negative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), apiRestResponse.getHttpStatusCode());
        Assert.assertEquals(apiRestResponse.getBody().getJSONArray("errorMessages").length(),
                            esbRestResponse.getBody()
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateComponentWithMandatoryParameters"},
            description = "jira {countComponentRelatedIssues} integration test with mandatory parameters.")
    public void testCountComponentRelatedIssuesWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                apiUrl + "/component/" + connectorProperties.getProperty("componentIdMandatory")
                + "/relatedIssueCounts";
    ...
    /**
     * Method Name: countComponentRelatedIssues Skipped Case: optional case Reason: No optional
     * parameter(s) to
     * assert
     */
     ...
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testCreateComponentWithMandatoryParameters"},
            description = "jira {countComponentRelatedIssues} integration test with negative case.")
    public void testCountComponentRelatedIssuesWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_countComponentRelatedIssues_negative.json");
    ...
    public void testCreateBulkIssueWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_createBulkIssue_mandatory.json");

        final JSONObject esbResponseObject = esbRestResponse.getBody().getJSONArray("issues").
                getJSONObject(0);
        ...
        Assert.assertEquals(apiRestResponseObject.getString("summary"),
                            connectorProperties.getProperty("summary"));
    }
    ...
    public void testCreateBulkIssueWithOptionalParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_createBulkIssue_optional.json");
        ...
        Assert.assertEquals(apiRestResponseObject.getJSONArray("labels").get(0),
                            connectorProperties.getProperty("label"));
    }
    ...
    public void testCreateBulkIssueWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_createBulkIssue_negative.json");
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
                                    "api_createBulkIssue_negative.json");
        final JSONObject apiResponseObject = apiRestResponse.getBody();

        Assert.assertEquals(esbResponseObject.getJSONArray("errors").toString(),
                            apiResponseObject.getJSONArray("errors")
                .toString());
    }
    ...
    public void testGetCommentByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getCommentById_mandatory.json");
        ...
        Assert.assertEquals(esbRestResponseObject.getString("created"),
                            apiRestResponseObject.getString("created"));
    }
    ...
    public void testGetCommentByIdWithOptionalParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getCommentById_optional.json");
        final JSONObject esbRestResponseObject = esbRestResponse.getBody();
    ...
    public void testGetCommentByIdWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getCommentById_negative.json");
    ...
    public void testAssignIssueToUserWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_assignIssueToUser_mandatory.json");
    ...
    public void testAssignIssueToUserWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_assignIssueToUser_negative.json");
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "PUT", apiRequestHeadersMap,
                                    "api_assignIssueToUser_negative.json");

        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("errors").getString("assignee"),
                            apiRestResponse
    ...
    public void testSendNotificationWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_sendNotification_mandatory.json");
     ...
     * Status: Skipped.
     * Reason : The method returns only "204 no content" as the response for successful method
     * execution.Therefore cannot assert the optional parameters.
     */
    ...
    public void testSendNotificationWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_sendNotification_negative.json");
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
                                    "api_sendNotification_negative.json");

        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("errorMessages").getString(0),
                            apiRestResponse
                .getBody().getJSONArray("errorMessages").getString(0));
    }
    ...
    public void testGetWatchersForIssueWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getWatchersForIssue_mandatory.json");
        final JSONObject esbResponseObject = esbRestResponse.getBody();
    ...
    public void testGetWatchersForIssueWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getWatchersForIssue_negative.json");
    ...
    public void testcreateIssueLinkWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_createIssueLink_mandatory.json");
        ...
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(issueLinkLocation, "GET",
                                                                       apiRequestHeadersMap);
        final JSONObject apiResponseObject = apiRestResponse.getBody();
    ...
    public void testCreateIssueLinkWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_createIssueLink_negative.json");
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
                                    "api_createIssueLink_negative.json");
        final JSONObject apiResponseObject = apiRestResponse.getBody();
     ...
     * @throws IOException
     */
    @Test(groups = {"wso2.esb"}, dependsOnMethods = {"testcreateIssueLinkWithMandatoryParameters"},
            description = "jira {getIssueLinkById} integration test with mandatory parameters.")
    public void testGetIssueLinkByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getIssueLinkById_mandatory.json");
        final JSONObject esbResponseObject = esbRestResponse.getBody();
        ...
        Assert.assertEquals(esbResponseObject.getJSONObject("inwardIssue").getString("id"),
                            apiResponseObject
    ...
    public void testListGroupUserPickerWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_listGroupUserPicker_mandatory.json");
        final JSONObject esbResponseObject = esbRestResponse.getBody();
    ...
    public void testListGroupUserPickerWithOptionalParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_listGroupUserPicker_optional.json");
        final JSONObject esbResponseObject = esbRestResponse.getBody();
    ...
    public void testListGroupUserPickerWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_listGroupUserPicker_negative.json");
    ...
    public void testListGroupPickerWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_listGroupPicker_mandatory.json");
        final JSONObject esbResponseObject = esbRestResponse.getBody();
    ...
    public void testListGroupPickerWithOptionalParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_listGroupPicker_optional.json");
        final JSONObject esbResponseObject = esbRestResponse.getBody();
    ...
    public void testListGroupPickerWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_listGroupPicker_negative.json");
    ...
    public void testGetAttachmentByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getAttachmentById_mandatory.json");
        final JSONObject esbResponseObject = esbRestResponse.getBody();
    ...
    public void testGetAttachmentByIdWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getAttachmentById_negative.json");
    ...
    public void testAddVotesForIssueWithNegativeCase() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_addVotesForIssue_negative.json");
    ...
    public void testGetProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        final String apiEndPoint = apiUrl +"/project/"+ connectorProperties.getProperty("project");
    ...
    /**
     * Positive test case for getComponentsOfProject method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    @Test(groups = {"wso2.esb"}, description = "jira {getComponentsOfProject} integration test" +
                                               " with mandatory parameters.")
    public void testGetComponentsOfProjectWithMandatoryParameters() throws IOException, JSONException {

        esbRequestHeadersMap.put("Action", "urn:getComponentsOfProject");

        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getComponentsOfProject_mandatory.json");
        final String apiEndPoint = apiUrl +"/project/"+ connectorProperties.getProperty("project")+"/components";
    ...
    /**
     * Positive test case for getAvatarsForProject method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    ...
    public void testGetAvatarsForProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getAvatarsForProject_mandatory.json");
        final String apiEndPoint = apiUrl +"/project/"+ connectorProperties.getProperty("project")+"/avatars";
    ...
    /**
     * Positive test case for getRolesOfProject method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    ...
    public void testGetRolesOfProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getRolesOfProject_mandatory.json");
        final String apiEndPoint = apiUrl +"/project/"+ connectorProperties.getProperty("project")+"/role";
    ...
    /**
     * Positive test case for getStatusesOfProject method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    ...
    public void testGetStatusesOfProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getStatusesOfProject_mandatory.json");
        final String apiEndPoint = apiUrl +"/project/"+ connectorProperties.getProperty("project")+"/statuses";
    ...
    /**
     * Positive test case for getVersionsOfProject method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    ...
    public void testGetVersionsOfProjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getVersionsOfProject_mandatory.json");
        final String apiEndPoint = apiUrl +"/project/"+ connectorProperties.getProperty("project")+"/versions";
    ...
    /**
     * Positive test case for getUserPermissions method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    ...
    public void testGetUserPermissionsWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getUserPermissions_mandatory.json");
        final String apiEndPoint = apiUrl +"/mypermissions?"+ connectorProperties.getProperty("project");
    ...
    /**
     * Positive test case for getDashboards method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    ...
    public void testGetDashboardsWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getDashboards_mandatory.json");
        final String apiEndPoint = apiUrl +"/dashboard";
    ...
    /**
     * Positive test case for getIssuePriorities method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
    ...
    public void testGetIssuePrioritiesWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap,
                                    "esb_getIssuePriorities_mandatory.json");
        final String apiEndPoint = apiUrl +"/priority";
    ...
    /**
     * Positive test case for getIssueTypes method with mandatory parameters.
     *
     * @throws JSONException
     * @throws IOException
     */
